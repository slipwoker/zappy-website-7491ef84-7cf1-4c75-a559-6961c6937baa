    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עמי אלומיניום משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7491ef84-7cf1-4c75-a559-6961c6937baa',
                    name: data.name || '',
                    email: data.email || '',
